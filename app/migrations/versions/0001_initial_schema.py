...
Revision ID: cacb360700ab
Revises: 
Create Date: 2026-07-22 08:13:08.066859
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_alert_configs_project_id'), 'alert_configs', ['project_id'], unique=False)
